...
----------
 * **아무런 맛이 없다** :: to be tasteless (expression)
 * 감기가 들었을 때는 음식이 아무런 맛이 없습니다. 
...
----------
 * **현금 자동 입출금기** :: ATM (noun)
 * 현금으로 지불해야 하는데, 이곳에 현금 자동 입출금기가 있습니까? 
...
----------
 * **천** :: thousand (numeral)
 * 그 것을 해야 할 천 가지의 이유가 있어. 
 * There are a thousand reasons to do it. 
----------
 * **땀** :: sweat (noun)
 * 조깅을 해서 땀을 비오듯 흘리고 있어요. 
...
----------
 * **맛이 쓴** :: bitter (adjective)
 * 전 맛이 쓴 커피를 싫어해요. 설탕을 조금 타면 좋아요. 
 * I don't like bitter coffee, I prefer it with a bit of sugar. 
----------
 * **생략하다** :: to dispense (verb)
 * 불필요한 세부사항은 생략합시다. 
 ...
 * I'm not a saint. 
----------
 * **알려지지 않다** :: to be unknown (verb)
 * 그의 근황은 알려지지 않고 있어요. 그런데, 제 생각엔 이 나라를 떠난 것 같아요. 
...
----------
 * **처음에는** :: at first (expression)
 * 처음에는 무엇을 말해야 할지 몰랐어요. 
 * At first I didn't know what to say. 
----------
 * **부족하다** :: short, lacking (adjective)
 * 유럽에는 주택들이 부족합니다. 
 * In Europe there is housing shortage. 
----------
 * **결국에는** :: in the end (expression)
 * 결국엔 전 그가 옳았다고 인정해야 했습니다. 
 * In the end I had to admit that he was right. 
----------
 * **부끄러움을 타다** :: shy (expression)
 * 너무 부끄러움을 타면 친구 사귀기가 힘들어요. 
 * Making friends is hard when you are painfully shy. 
----------
 * **꽃** :: flower (noun)
 * 저를 몰래 흠모하는 사람이 저에게 꽃을 보냈습니다! 
...
----------
 * **~에 맞서** :: against (expression)
 * 가끔은 온 세상이 나에 맞서 있다는 생각이 든다! 
...
----------
 * **연주하다** :: to play (an instrument) (expression)
 * 그는 피아노를 명인처럼 연주합니다. 
...
----------
 * **발견하다** :: to uncover (verb)
 * 그들의 탐험으로 고대 유적을 발견했습니다. 
 * Their expedition uncovered ancient ruins. 
----------
 * **건강에 해로운** :: unhealthy (adjective)
 * 흡연은 건강에 해로운 습관입니다. 
 * Smoking is an unhealthy habit. 
----------
 * **시원하게 하다** :: to cool (verb)
 * 선풍기가 방을 시원하게 해 줄 거예요. 
 * The fan will cool the room. 
----------
 * **무모한** :: reckless (adjective)
 * 정말 무모한 운전자네! 운전 중에 전화를 하다니! 
 * What a reckless driver - he's on the phone! 
----------
 * **짙은 감색의** :: navy (adjective)
 * 어둠 속에서 난 실수로 짙은 감색의 양말 한 짝과 검정색 양말 한 짝을 신었어. 
...
----------
 * **여기** :: here, this place (pronoun)
 * 여기는 정말 덥다. 
 * It's very hot in here. 
----------
 * **폭포** :: waterfall (noun)
 * 우리가 들을 수 있었던 소리는 포효하는 듯한 폭포 소리뿐이었다. 
...
----------
 * **위험** :: danger (noun)
 * 이 동물들은 멸종할 위험에 처해 있습니다. 
 * These are animals in danger of extinction. 
----------
 * **요구하다** :: to require (verb)
 * 자전거 탈 때, 헬멧을 쓰는 것은 법으로 요구됩니다. 
 * Wearing a helmet is required by law when bicycling. 
----------
 * **요리하다** :: to cook (verb)
 * 전 포도주로 요리하는 것을 좋아해요. 
...
----------
 * **지옥** :: hell (noun)
 * 지옥이 그렇게 나쁜 곳일 거라고 생각하십니까? 
 * Do you think that hell will be such a bad place? 
----------
 * **탑** :: tower (noun)
 * 그 처녀는 탑에서 그의 기사를 볼 수 있었습니다. 
...
----------
 * **복수하다** :: to get revenge (verb)
 * 그 피해자는 가해자에게 복수를 했습니다. 
 * The victim got revenge on the wrongdoer. 
----------
 * **실망** :: disappointment (noun)
 * 패배에 대해 실망을 감출 수가 없었습니다. 
 * I couldn't hide my disappointment over the defeat. 
----------
 * **착륙하다** :: to land (verb)
 * 비행기가 착륙할 때까지 자리에 앉아 있어야 합니다. 
...
----------
 * **속쓰림** :: heartburn (noun)
 * 불안감이 속쓰림의 원인이 될 수있습니다. 
 * Anxiety can cause heartburn. 
----------
 * **변기 물을 내리다** :: to flush the toilet (expression)
 * 변기 물을 내리는 것을 잊지 마세요. 
 * Don't forget to flush the toilet. 
----------
 * **장비를 갖추다** :: to be rigged (expression)
 * 배는 출항하기 위해 장비를 다 갖추었다. 
 * This ship has rigged for the voyage. 
----------
 * **강도 사건** :: robbery (noun)
 * 경찰은 강도 사건 현장에 늦게 도착했어요. 
