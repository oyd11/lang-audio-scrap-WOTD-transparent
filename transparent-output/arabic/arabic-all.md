 ...
 * Your company is competing with other companies in the world. 
----------
 * **نسى** :: to forget (verb)
 ...
 * This is expensive. 
----------
 * **عَبر الإنترنت** :: online (adjective)
 * تستطيع أن تَبحَث عَن الشقق عبر الإنترنت وتقارن أسعار. 
 * You can look up apartments online and compare prices. 
----------
 * **أمس** :: yesterday (adverb)
 * هذا الفيلم عُرضَ أمس. 
 * This movie came out yesterday. 
 ...
 * I have a friend from Morocco. 
----------
 * **عدد السُكان** :: population (noun)
 * عدد سُكان بيروت ٢٫٢ مليون نسمة. 
 * The population of Beirut is 2.2 million. 
----------
 * **الآن** :: now (adverb)
 * هل تسمعني الآن؟ 
 * Do you hear me now? 
 ...
 * I apologize for the delay. 
----------
 * **تحديداً** :: exactly (adverb)
 * أين تقع مدينة دمشق تحديداً على الخريطة؟ 
 * Where exactly is Damascus is located on the map? 
----------
 * **هنا** :: here (adverb)
 * ولدوا هنا. 
 * They were born here. 
 ...
 * When will the train arrive at the station? 
----------
 * **أثر** :: to influence (verb)
 * محمود درويش أثر في الكثير من الشعراء والأدباء. 
 * Mahmoud Darweesh influenced many poets and writers. 
----------
 * **هناك** :: there (adverb)
 * يمكنك الجلوس هناك. 
 * You can sit there. 
 ...
 * My favorite color is black. 
----------
 * **حضارة** :: civilization (noun)
 * الحضارة المصرية من أقدم الحضارات في العالم. 
 * Egyptian civilization is one of the oldest civilizations in the world. 
----------
 * **أقل** :: less (adverb)
 * يتقاضى أقل من زوجته. 
 * He makes less money than his wife. 
...
----------
 * **قائِد** :: leader (noun)
 * يعتبر بعض الزعماء العرب دكتاتوريين. 
 * Some Arab leaders are considered dictators. 
----------
 * **معظم** :: most (adverb)
 * معظم المشاركين حاضرون. 
 * Most of the participants are present. 
 ...
 * Did you ask them about the house address? 
----------
 * **تقرير إخباري** :: news report (collocation)
 * ووفقاً لتقرير إخباري، الانتخابات تبدأ غداً. 
 * According to a news report, voting starts tomorrow. 
----------
 ...
 * The food is excellent at this restaurant. 
----------
 * **ذَكي** :: smart (adjective)
 * كان طالِب ذكي جداً وحصل على علامات عالية في كل مادة دراسية. 
 * He was a very smart student and got high grades in every subject. 
----------
 * **الأقل** :: the least (adjective)
 * هذا البرنامج هو الأقل كلفة. 
 * This program is the least expensive one. 
 ...
 * The American president is Barack Obama. 
----------
 * **غير قانوني** :: illegal (adjective)
 * بيع الكحول في السعودية غير قانوني . 
 * It is illegal to sell alcohol in Saudi Arabia. 
----------
 ...
 * Radia and Samia have lived in the United States since 2001. 
----------
 * **إعتمدَ على** :: to depend on (verb)
 * هو خائف أنه سيضطر أن يعتمد على مساعدات حكومية إذا لم يستطيع إيجاد عمل بسرعة. 
 * He’s afraid he will have to depend on government aid if he cannot find a job soon. 
----------
 * **عاجلاً** :: soon (adverb)
 * يجب أن ترى الطبيب عاجلاً. 
 * You should see a doctor soon. 
 ...
 * They answered the question. 
----------
 * **أَغْلَبيِّة** :: majority (noun)
 * هَل أغلبية الطُلاب الأمريكيين يَعملون؟ 
 * Does the majority of American college students work? 
----------
 * **غداً** :: tomorrow (adverb)
 * سألتقي بأصدقائي غداً. 
 * I will meet my friends tomorrow. 
...
----------
 * **خَيار** :: option (noun)
 * كان خياره الوحيد أن يشتري هاتفاً جديداً حيث أنه لم يستطيع إصلاح القديم. 
 * His only option was to buy a new phone since he couldn’t fix the old one. 
----------
 * **أيضاً** :: also (adverb)
 * أحب الموسيقى و الرقص أيضاً. 
 * I love music and dance also. 
 ...
 * This road is very bad. 
----------
 * **بِالتَّأْكيد** :: definitely (adverb)
 * بالتأكيد هناك حل لهذه المشكلة دون إستعمال العنف. 
 * There is definitely a way to solve this problem without violence. 
----------
 * **فعلاً** :: truly (adverb)
 * أنت فعلاً شاب موهوب. 
 * You are truly a talented young man. 
 ...
 * He added sugar to the coffee. 
----------
 * **لا تَقْلَق.** :: Don't worry. (interjection)
 ...
 * How can I correct my pronunciation? 
----------
 * **مُتَعَلِق ب** :: related to (adjective)
 * هل هذه المقالة حول الإقتصاد الكويتي متعلقة بهذا الفلم الوثائقي عن الخليج؟ 
 * Is this article about Kuwait’s economy related to this documentary about the Gulf? 
----------
 * **حفلة** :: party (noun)
 * الحفلة ستكون غداً بعد الظهر. 
 * The party will be tomorrow afternoon. 
...
----------
 * **اسْتِمارة** :: form (noun)
 * يَجِب أن تملأ الإسْتِمارة وتقدمها قبل الموعد النهائي. 
 * You must fill out the form and submit it before the deadline. 
----------
 * **مصنع** :: factory (noun)
 * خالد يعمل مع والده في المصنع. 
 * Khalid works with his father in the factory. 
 ...
 * Can I pay with a credit card? 
----------
 * **الحَرَم الجامِعي** :: campus (noun)
 * هَل يُمكِنُك الذهاب في جولة حَولَ الحَرَم الجامعي ومقابلة بعض الأساتذة؟ 
 * Can you take a tour on campus and meet some of the professors? 
----------
 * **إدارة** :: administration (noun)
 * من المسؤول في هذه الإدارة؟ 
 * Who is in charge in this administration? 
 ...
 * It's hard for me to speak this language. 
----------
 * **يا إلهي!** :: Oh my God! (expression)
 * يا إلهي، سعر هذا البيت عالي جداً! 
 * Oh my God, the price of this house is so high! 
----------
 * **عاصمة** :: capital (noun)
 * القاهرة هي عاصمة مصر. 
 * Cairo is the capital of Egypt. 
 ...
 * God bless you! 
----------
 * **خِبرة** :: experience (noun)
 * لَقَد اكتسبتُ خِبرة جَيِّدة من عملي في هذه الشركة. 
 * I gained good experience from working at this company. 
----------
 * **أحياناً** :: sometimes (adverb)
 * أشتاق إلى أصدقائي أحياناً. 
 * I miss my friends sometimes! 
 ...
 * This is the car rental office. 
----------
 * **يَكْتَسِب** :: to gain (verb)
 * إكتسبت شهرة بعد ما ألقت ذاك الخطاب عن حقوق المرأة. 
 * She gained popularity after giving that speech about women’s rights. 
----------
 * **غداء** :: lunch (noun)
 * أود أنْ أتناول طعام الغداء في غرفتي. 
 * I would like to have my lunch in my room. 
 ...
 * Fatima agreed to sell her house. 
----------
 * **يُعَبِّر** :: to express (verb)
 * الكثير من الأغاني العربية تعبرعن الحب للوطن. 
 * Many Arabic songs express love for one’s homeland. 
----------
 * **صيدلي** :: pharmacist (noun)
 * عليك استشارة الصيدلي قبل أن تأخذ أي دواء. 
 * You have to consult the pharmacist before taking any medicine. 
 ...
 * The company needs employees. 
----------
 * **مَشاعِر** :: feelings (noun)
 * أستطيع أن أُعبِر عَن َمشاعري خِلال الشِعِر. 
 * I can express my feelings through poetry. 
----------
 * **فخم** :: luxurious (adjective)
 * هذه سيارة فخمة. 
 * This is a luxurious car. 
 ...
 * The work here is easy. 
----------
 * **حَديث** :: modern (adjective)
 * إن التكنولوجيا الحديثة تسهل حياتنا اليومية. 
 * Modern technology is making our daily lives more convenient. 
----------
 * **عربي** :: Arabic (adjective)
 * أمي تحب الموسيقى العربية. 
 * My mother likes Arabic music. 
 ...
 * It will be hot in the morning. 
----------
 * **مُتقدّم** :: developed (adjective)
 * سَمِعتُ أن الإمارات دولة جداً مُتَقدمة. 
 * I heard that the UAE is a very developed country. 
----------
 * **اللّيلة** :: tonight (adverb)
 * سنتقابل اللّيلة. 
 * We will meet tonight. 
...
----------
 * **لاجيء** :: refugee (noun)
 * أنا متطوع في مخيم للاجئين . 
 * I am a volunteer at a refugee camp. 
----------
 * **مصطلح** :: term (noun)
 * أريد أن أتعلم هذه المصطلحات. 
 * I want to learn these terms. 
 ...
 * The government faced an energy crisis and is now looking for alternative sources. 
----------
 * **مرحباً** :: welcome (adverb)
 * مرحباً بكم في بيتنا. 
 * Welcome to our house. 
 ...
 * The bank will close at five. 
----------
 * **وَضْع** :: situation (noun)
 * هو في وضع سيء ويحتاج إلى المساعدة. 
 * He is in a bad situation and needs help. 
----------
 * **عادةً** :: usually (adverb)
 * عادةً ، نأخذ الحافلة من هذه المحطة. 
 * We usually take the bus from this station. 
 ...
 * Hanan has not discussed the issue with her parents before. 
----------
 * **توفي** :: to pass away (verb)
 * لقد توفي خلال عملية قلب وعمره خمسة وسبعين عاماً. 
 * He passed away during a heart surgery at the age of seventy five. 
----------
 * **طقس** :: weather (noun)
 * الطقس بارد في الشتاء. 
 * The weather is cold during winter. 
...
----------
 * **حادِث** :: accident (noun)
 * تعرض صديقي لحادِث سيارة وهو الآن في المستشفى. 
 * My friend was in a car accident and is now in the hospital. 
----------
 * **عائلة ممتدة** :: extended family (noun)
 * رانيا تعيش مع عائلتها. 
 * Ranya lives with her family. 
----------
 * **أحضر** :: to bring (verb)
 * سيحضرون بيتزا للعشاء. 
 * They will bring a pizza for dinner. 
----------
 * **تَقاعدَ** :: to retire (verb)
 * كم يجب أن يكون عمرك لتتقاعد من عمل حكومي؟ 
 * How old must you be to retire from a government job? 
----------
 * **بجانب** :: beside (preposition)
 * المطعم بجانب الفندق. 
 * The restaurant is beside the hotel. 
 ...
 * How can I calculate the exchange rate? 
----------
 * **مَنصِب** :: position (noun)
 * بقي في نفس المنصب كوزير لثلاثين عاماً. 
 * He remained in the same position as minister for thirty years. 
----------
 * **مقبلات** :: appetizers (noun)
 * سنطلب مقبلات قبل العشاء. 
 * We will order appetizers before dinner. 
 ...
 * The audience is applauding the new president. 
----------
 * **الأماكِن العامة** :: public places (collocation)
 * انه غير قانوني أن تدخن في الأماكن العامة. 
 ...
 * They collect stamps. 
----------
 * **يَتوقَع** :: to expect (verb)
 * لم أتوقع أن أسمع خبر وفاته على الراديو هذا الصباح. 
 * I didn’t expect to hear about his death on the radio this morning. 
----------
 * **مرحاض** :: toilet (noun)
 * أين المرحاض من فضلك؟ 
 * Where is the toilet, please? 
...
----------
 * **تفاصيل** :: details (noun)
 * من الصعب أن أتذكر كل تفاصيل الحدث. 
 * It is difficult to remember all the details of the incident. 
----------
 * **حمَام** :: bathroom (noun)
 * هل هناك بانيو في الحمام؟ 
 * Is there a bathtub in the bathroom? 
 ...
 * You have to concentrate on your work. 
----------
 * **حالِياً** :: currently (adverb)
 * بسام يبحث حالياً عن عمل في الخليج بعد حصوله على شهادة. 
 * Bassam is currently trying to find a job in the Gulf after earning his degree. 
----------
 * **جميل** :: beautiful (adjective)
 * هذه صورة جميلة. 
 * This is a beautiful picture. 
...
----------
 * **مَنظَر** :: view (noun)
 * حَجزنا غُرفة بِمَنظَر جميل تطل على البحر الميت. 
 * We booked a room with a nice view overlooking the Dead Sea. 
----------
 * **سبح** :: to swim (verb)
 * أسبح كل يوم. 
 * I swim every day. 
 ...
 * I consider you my friend. 
----------
 * **فاخِر** :: fancy (adjective)
 * بَقينا في فُندُق فاخِر في قطر فيه مسبح ومطعم. 
 * We stayed at a fancy hotel in Qatar with a pool and restaurant. 
----------
 * **صيف** :: summer (noun)
 * أحمد يحب الصيف. 
 * Ahmed likes summer. 
 ...
 * Have you photocopied your ID card? 
----------
 * **طبيعة** :: natural (adjective)
 * من الطبيعي أن تجد أشجار زيتون داخل الفناءات الخلفية في لبنان حيث يصنعون الكثير من زيت الزيتون. 
 * It is natural to find olive trees in people’s backyards in Lebanon where they make lots of olive oil. 
----------
 * **جداً** :: very (adverb)
 * الطقس حار جداً. 
 * It's very hot. 
 ...
 * I need to practice Arabic. 
----------
 * **تَشْكيلَة** :: variety (noun)
 * المأكولات العربية فيها تشكيلة من الأطباق الرئيسية والمقبلات. 
 * Arabic cuisine has a variety of main dishes and appetizers. 
----------
 * **متى** :: when (adverb)
 * متى ستقلع الطائرة؟ 
 * When will the plane take off? 
 ...
 * Happy birthday! 
----------
 * **تقريباً** :: approximately (adverb)
 * الرحلة من عمان إلى باريس تستغرق تقريباً خمس ساعات. 
 * It takes approximately five hours to fly from Amman to Paris. 
----------
 * **وقت** :: time (noun)
 * يقضي وقته في العمل. 
 * He spends his time working. 
 ...
 * The girl danced at the party. 
----------
 * **رئيسي** :: main (adjective)
 * أخذت الشارع الرئيسي وعلقت بالإزدحام لمدة ساعة. 
 * I took the main road and got stuck in traffic for an hour. 
----------
 * **مشمس** :: sunny (adjective)
 * اليوم مشمس. 
 * It's sunny today. 
 ...
 * I have a new idea. 
----------
 * **طائِفة دينية** :: religious sect (collocation)
 * الَيمن مُقَسَمة إلى طائِفَتين دينيتين رئيسيتين الشيعة والسنة. 
 * Yemen is divided into two main religious sects; Shiites and Sunnis. 
----------
 * **سكن** :: to live (verb)
 * فاطمة تسكن في بوسطن. 
 * Fatima lives in Boston. 
 ...
 * Children always say the truth. 
----------
 * **الضحايا المدنيين** :: civilian casualties (collocation)
 * عدد الضحايا المدنيين ظل مرتفعاً خلال الحرب. 
 * Civilian casualties remained at high levels during the war. 
----------
 * **اسم** :: name (noun)
 * اسمهُ علي. 
 * His name is Ali. 
 ...
 * My friends work at the movie theater. 
----------
 * **عَرْض/تخفيضات** :: sale (noun)
 * فقط أشتري ملابس من هذا المحل عندما يكون هناك عرض. 
 * I only buy clothes from this store when there is a sale. 
----------
 * **منطقة** :: area (noun)
 * أعمل في هذه المنطقة. 
 * I work in this area. 
 ...
 * How much is the watch? 
----------
 * **رسمي** :: formal (adjective)
 * يجب أن تلبس لباساً رسمياً مثل بدلة إلى مقابلة العمل. 
 * You should wear something formal like a suit to the job interview. 
----------
 * **أراد** :: to want (verb)
 * هل تريد الكتب الآن؟ 
 * Do you want the books now? 
...
----------
 * **جيل** :: generation (noun)
 * في العالم العربي، كل من الجيل الجديد والقديم يستمعون إلى أغاني فيروز. 
 * In the Arab world, both the young and old generations listen to Fairuz’s songs. 
----------
 * **سعيد** :: happy (adjective)
 * ليلى كانت سعيدة جداً. 
 * Laila was very happy. 
...
----------
 * **يَبدو** :: to seem (verb)
 * يبدو أنه يعرف أكثر مما توقعت عن تاريخ الشرق الأوسط. 
 * He seems to know more about Middle Eastern history than I thought. 
----------
 * **الجمعة** :: Friday (noun)
 * اليوم هو الجمعة. 
 * Today is Friday. 
...
----------
 * **جامع** :: mosque (noun)
 * جدي هو الإمام في هذا الجامع. 
 * My grandfather is the Imam of this mosque. 
----------
 * **إشترى** :: to buy (verb)
 * هل اشترى أخوك سيارة جديدة؟ 
 * Did your brother buy a new car? 
...
----------
 * **نَشاط** :: activity (noun)
 * هذا النادي الرياضي فيه الكثير من النشاطات مثل السباحة وركوب الخيل. 
 * This sports club has a lot of activities such as swimming and horse riding. 
----------
 * **أخذ** :: to take (verb)
 * هل تأخذون شيكات؟ 
 * Do you take checks? 
...
----------
 * **مُتَحَمِس** :: excited (adjective)
 * أنا متحمسة جداً أن أبدأ عملي الجديد! 
 ...
 * We are from Jordan. 
----------
 * **حَجْز** :: reservation (noun)
 * يجب أن ألغي حجز الفندق لأن طيارتي قد تأخرت. 
 * I need to cancel the hotel reservation because my flight was delayed. 
----------
 * **إستقلال** :: independence (noun)
 * عيد الاستقلال في الرابع من تموز. 
 * Independence Day is on the fourth of July. 
...
----------
 * **مُقَدَس** :: holy (adjective)
 * القدس مدينة مُقَدَسة لثلاثة أديان. 
 * Jerusalem is a holy city to three religions. 
----------
 * **أصبح** :: to become (verb)
 * سيصبح الحليب جبناً. 
 * The milk will become cheese. 
...
----------
 * **هيا بِنا!** :: Let’s go! (interjection)
 * هيا بنا، سوف نتأخر! 
...
----------
 * **الحَمدُ الله** :: Praise be to God./ Thank God (expression)
 * نحن بصحة جيدة والحمد لله. 
 * We are in good health, praise be to God. 
----------
 * **نشيط** :: active (adjective)
 * أحمد طالب نشيط. 
 * Ahmed is an active student. 
 ...
 * I have only one bag. 
----------
 * **عِدة** :: several (adjective)
 * هُناك عِدة أطباق مُختلفة على الطاولة. 
...
----------
 * **يَحتفل** :: to celebrate (verb)
 * احتفلوا بعيد الفطر مع حلويات وقهوة عربية. 
 * They celebrated Eid Al-fitr with sweets and Arabic coffee. 
----------
 * **باتجاه** :: towards (prepostion)
 * قد السيارة باتجاه المطار. 
 * Drive towards the airport. 
...
----------
 * **لَهجة** :: dialect (noun)
 * إضافة إلى اللغة العربية الفصحى واللغة الفرنسية، المغاربة أيضاً يَتَكَلَمون اللهجة المغربية. 
 * Besides modern standard Arabic and French, Moroccans also speak the Moraccan dialect. 
----------
 * **سافر** :: to travel (verb)
 * في العام الماضي، سافرنا إلى لندن. 
 * Last year, we traveled to London. 
...
----------
 * **خاصَةً** :: especially (adverb)
 * أحب الأدب العربي خاصةً الشعر العربي. 
 * I love Arabic literature, especially Arabic poetry. 
----------
 * **سمك** :: fish (noun)
 * لا أحب السمك المقلي. 
 * I don't like fried fish. 
...
----------
 * **مبروك!** :: Congratulations! (interjection)
 * مبروك على خطبتك! 
...
----------
 * **عادات** :: customs (noun)
 * وفقاً للعادات العربية، إنه غير لائق أن ترفض مشروب مثل الشاي أو القهوة. 
 * According to Arab customs, it is impolite to refuse a beverage such as tea or coffee. 
----------
 * **إختار** :: to choose (verb)
 * عمي و زوجته اِختارا زيارة إسبانيا. 
 * My uncle and his wife chose to visit Spain. 
...
----------
 * **تقاليد** :: traditions (noun)
 * إن التقاليد العربية قد تختلف في أنحاء العالم العربي. 
 * Arab traditions can differ across the Arab world. 
----------
 * **جامعة** :: university (noun)
 * هل ستدرسين في الجامعة الأمريكية ببيروت؟ 
 * Will you study at the American University in Beirut? 
...
----------
 * **الضفة الغربية** :: West Bank (collocation)
 * سيطر الأردن على الضفة الغربية عام ١٩٥٠. 
 * Jordan controlled the West Bank in 1950. 
----------
 * **ساعد** :: to help (verb)
 * هل من الممكن أن تساعديني؟ 
 * Could you help me? 
...
----------
 * **تدَخَّلَ** :: to interfere (verb)
 * لا يجب ان تتدخّل في شؤون الناس. 
...
----------
 * **أقنع** :: to convince (verb)
 * حاول المحامي أن يقنع القاضي بأن الرجل كان بريئاً. 
...
----------
 * **ولي العهد** :: Crown Prince (collocation)
 * محمد بن سلمان أصبح ولي عهد السعودية في عام ٢٠١٧. 
 * Mohammed bin Salman became Crown Prince of Saudi Arabia in 2017. 
----------
 * **شرطة** :: police (noun)
 * أين مركز الشرطة من فضلك؟ 
 * Where is the police station, please? 
...
----------
 * **إعتقد** :: to believe (verb)
 * أعتقد أن أسعار النفط ستستمر في الإرتفاع بالمستقبل. 
 * I believe gas prices will continue to rise in the future. 
----------
 * **كان** :: to be (verb)
 * سيكون الجو بارداً جداً غداً. 
 * It will be very cold tomorrow. 
...
----------
 * **حرب الأهلية** :: civil war (collocation)
 * الحرب الأهلية السورية مستمرة حتى يومنا هذا. 
 * The civil war in Syria is ongoing to this day. 
----------
 * **أفضل** :: better (adjective)
 * حالته الصحية أفضل من السنة الماضية. 
 * His health is better than last year. 
...
----------
 * **الربيع العربي** :: Arab Spring (collocation)
 * بدأ الربيع العربي في تونس عام ٢٠١١. 
