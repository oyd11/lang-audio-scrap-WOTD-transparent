 ...
 * Las víctimas de la inundación fueron rescatadas en helicóptero. 
...
----------
 * **el lápiz de color** :: crayon (expression)
 * Me gusta dibujar con lápiz de color. 
 * I like to draw with crayon. 
----------
 * **el barbero** :: barber (noun)
 * Este libro se llama "El barbero de Sevilla" 
 * This book is called "The Barber of Seville." 
...
----------
 * **el cajero automático** :: ATM (expression)
 * Necesito pagar en efectivo. ¿Hay cajeros automáticos por aquí? 
...
----------
 * **el sudor** :: sweat (noun)
 * Después de correr acabo empapado de sudor. 
 ...
 * No me gusta el café amargo, lo prefiero con un poco de azúcar. 
...
----------
 * **el intérprete** :: interpreter (noun)
 * Él es un intérprete de conferencias. 
 * He is a conference interpreter. 
----------
 * **ponerse enfermo** :: to get sick (expression)
 * El mismo día Francisco se ha puesto enfermo también. 
 * The very same day Francisco got sick as well. 
...
----------
 * **prescindir de** :: to dispense with (expression)
 * Prescindamos de los detalles inútiles. 
...
----------
 * **el rotulador** :: marker (noun)
 * Quiero el rotulador naranja. 
...
----------
 * **el perro** :: dog (noun)
 * ¡Te atraparé, linda, y a tu perrito también! 
 ...
 * Esta dirección es desconocida para mí. 
...
----------
 * **al principio** :: at first (expression)
 * Al principio no sabía que decir. 
...
----------
 * **la escasez** :: shortage (noun)
 * En Europa hay escasez de viviendas. 
...
----------
 * **al final** :: in the end (expression)
...
----------
 * **la flor** :: flower (noun)
 * Me ha regalado un ramo de flores. 
...
----------
 * **la ropa** :: clothing (noun)
 * ¡Quítate esa ropa tan sucia! 
...
----------
 * **la llama** :: flame (noun)
 * Sus ojos son como llamas. 
 * Her eyes are like flames. 
----------
 * **la manga** :: sleeve (noun)
 * Hace mucho frío; mejor ponte algo de manga larga. 
 * It's too cold; you'd better wear something with long sleeves. 
...
----------
 * **la ayuda** :: aid (noun)
 * Nosotros buscamos una ayuda financiera. 
 * We're searching for some financial aid. 
----------
 * **la luz** :: light (noun)
 * Con la luz del día lo veremos de otra manera. 
...
----------
 * **colgar** :: to hang (verb)
 * Hay telarañas colgando del techo. 
 ...
 * Ese cementerio está lleno y por eso no pueden enterrar a nadie. 
 ...
 * I need to pay in cash. Is there an ATM here? 
----------
 * **escalofriante** :: chilling (adjective)
 ...
 * Thanks for your support. 
----------
 * **oscurecerse** :: to darken (verb)
 * Ahora se oscurece a las cuatro de la tarde. 
 * Now it darkens at four in the afternoon. 
----------
 * **la culpa** :: fault (noun)
 * No es mi culpa. 
 * It is not my fault. 
 ...
 * In the end I had to admit that he was right. 
----------
 * **la calabaza** :: pumpkin (noun)
 * Nosotros decoramos las calabazas para Halloween. 
 * We decorate the pumpkins for Halloween. 
----------
...
----------
 * **el truco** :: trick (noun)
 * El mago hace muchos trucos de magia. 
...
----------
 * **había una vez** :: once upon a time (expression)
 ...
 * We'll see things differently in the cold light of day. 
----------
 * **las hojas** :: leaves (noun)
 * Los colores de las hojas son muy bonitos. 
 * The colors of the leaves are very pretty. 
----------
 * **la decepción** :: disappointment (noun)
 * No pude ocultar la decepción tras la derrota. 
...
----------
 * **el ardor de estómago** :: heartburn (expression)
 ...
 * He did it for love. 
----------
 * **indígena** :: native (adjective)
 * Esas son unas frutas indígenas. 
 * Those are some native fruits. 
----------
 * **tirar de la cadena** :: to flush the toilet (expression)
 ...
 * I'm flying to Argentina in February. 
----------
 * **el atraco** :: robbery (noun)
 * La policía llegó tarde a la escena del atraco. 
 ...
 * My chest hurts. 
----------
 * **borroso** :: blurred (adjective)
 * Yo tengo un recuerdo borroso. 
 * I have a blurred memory. 
----------
 * **la impresora** :: printer (noun)
...
----------
 * **el malabarista** :: juggler (noun)
 * Los espectadores aplaudieron al malabarista. 
...
----------
 * **destapar** :: to reveal (verb)
 * El expediente destapó un escándalo. 
...
----------
 * **la carretera** :: highway (noun)
 * Algunos dicen que la vida es una carretera. 
 ...
 * Here there is a church and a waterfall. 
----------
 * **el cuchillo** :: knife (noun)
 * El ladrón tiene un cuchillo. 
 * The thief has a knife. 
----------
 * **cadena perpetua** :: life imprisonment (expression)
 * El culpable fue condenado a cadena perpetua. 
 ...
 * Enough already! 
----------
 * **agradecido** :: thankful (adjective)
 * La familia está agradecida por las flores. 
 * The family is thankful for the flowers. 
----------
 * **el palurdo** :: bumpkin (noun)
 * Fíjate en el palurdo ese. Está leyendo un periódico pero está al revés. 
 * Check this bumpkin out. He's reading the paper but it's upside down. 
----------
 * **la llave** :: key (noun)
 * He perdido mi llave de nuevo. 
 * I have lost my key again. 
...
----------
 * **el culebrón** :: soap opera (noun)
 * Los culebrones sudamericanos son grandes éxitos entre las amas de casa y niños. 
 * South American soap operas are great hits among housewives and kids. 
----------
 * **el peligro** :: danger (noun)
 * Estos son animales en peligro de extinción. 
 * These are animals in danger of extinction. 
...
----------
 * **el osito de peluche** :: teddy bear (expression)
 * Está prohibido traer ositos de peluche al cole. 
...
----------
 * **la alabanza** :: praise (noun)
 * Sus acciones fueron dignas de alabanza. 
 ...
 * It's dangerous if you don't look upon crossing the street. 
----------
...
----------
 * **la tos** :: cough (noun)
 * Geraldo tiene mucha tos. 
 * Geraldo is coughing a lot. 
----------
...
----------
 * **fumar** :: to smoke (verb)
 * La gente que fuma pueden conseguir cáncer. 
...
----------
 * **seco** :: dry (adjective)
 * Las toallas ya están secas. 
 * The towels are already dry. 
----------
 ...
 * My work here is done. 
----------
 * **el asiento** :: seat (noun)
 * El muchacho está sentado en su asiento. 
 * The boy is seated in his seat. 
----------
 * **la arpía** :: hag (noun)
...
----------
 * **la nieve** :: snow (noun)
 * Las chicas hacen un hombre de nieve. 
...
----------
 * **nevar** :: to snow (verb)
 * Va a nevar mucho esta semana. 
 * It is going to snow a lot this week. 
----------
 ...
 * Cada día los padres regalan algo a los hijos. 
 * Each day the parents give something to their kids. 
----------
...
----------
 * **la víspera** :: eve (noun)
 * El novio está nervioso en la víspera de su boda. 
 ...
 * The police surprise the robber outside of the bank. 
----------
 * **desagradable** :: unpleasant (adjective)
 * Hay un olor muy desagradable por aquí. 
 * There is a very unpleasant smell around here. 
 ...
 * The audience applauded the juggler. 
----------
 * **los juegos de mesa** :: board games (noun)
