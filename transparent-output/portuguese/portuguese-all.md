...
----------
 * **manchete** :: headline (noun)
 * Você viu as manchetes hoje de manhã? 
...
----------
 * **segunda-feira** :: Monday (noun)
 * Ninguém gosta de acordar cedo às segundas-feiras. 
 * Nobody likes to get up early on Mondays. 
----------
 * **completar** :: to complete (verb)
 * Você me completa. 
 * You complete me. 
...
----------
 * **derreter** :: to melt (verb)
 * A neve do inverno já derreteu. 
...
----------
 * **rascunho** :: draft (noun)
 * O primeiro rascunho estará pronto até amanhã. 
...
----------
 * **lagartixa** :: gecko (noun)
 * Tem uma lagartixa na banheira! 
 * There is a gecko in the bathtub! 
----------
 * **treinamento de incêndio** :: fire drill (expression)
 * Não entre em pânico, é só um treinamento de incêndio. 
 * Don't panic; it's only a fire drill. 
----------
 * **desculpe** :: sorry (adjective)
 * Oi, pessoal! Desculpe o atraso. 
 * Hi everyone! Sorry I'm late. 
----------
 * **descongelar** :: to defrost (verb)
 * Você tem que descongelar o peru antes de colocá-lo no forno. 
 ...
 * Os veleiros usam o vento para se mover na água. 
...
----------
 * **sol** :: sun (noun)
 * Os jardins precisam de um bom solo, sol e água regularmente. 
 * Gardens need good soil, sun, and regular watering. 
----------
 * **concordar** :: to agree (verb)
 * Concordo com você nesse assunto. 
...
----------
 * **semana** :: week (noun)
 * Quantas semanas vai demorar este projeto? 
 * How many weeks does this project have to take? 
----------
 * **ultrapassar** :: to pass (verb)
 * Você não pode ultrapassar nesse trecho de estrada. 
 ...
 * Last night I dreamt I was being abducted by aliens. 
----------
 * **maioria** :: majority (noun)
 * Ele teve a maioria dos votos. 
 * He had the majority of the votes. 
----------
 * **aleatoriamente** :: at random (adverb)
 * Escolhemos um lugar aleatoriamente. 
 ...
 * Não estou entendendo. Você pode repetir? 
 ...
 * During our trip around São Paulo we visited the cliffs of Serra Negra. 
----------
 * **língua** :: language (noun)
 * Ele tem talento para aprender línguas. 
 * He has a talent for learning languages. 
----------
 * **concessionária** :: car dealership (noun)
 * Minha concessionária não tem o modelo que eu estou procurando. 
...
----------
 * **verbo** :: verb (noun)
 * Os verbos são usados para expressar ações. 
 * Verbs are used to express actions. 
----------
 * **cavanhaque** :: goatee (noun)
 * Ele parece meio sinistro de cavanhaque. 
...
----------
 * **usar** :: to wear (verb)
 * Esse é um chapéu muito feio que você está usando! 
 * That's a very ugly hat you're wearing! 
----------
 * **mostrar** :: to show (verb)
 * Mostre-me seu carro novo. 
 ...
 * Please, have your boarding pass ready at the counter. 
----------
 * **oxigênio** :: oxygen (noun)
 * Em lugares muito altos, há menos oxigênio no ar. 
 ...
 * I can't tell you the answer, but I'll give you a hint. 
----------
 * **observar** :: to watch (verb)
 * Aprendi observando você, Papai! 
 * I learned it from watching you, Dad! 
----------
 * **selecionar** :: to select (verb)
 * No menu principal, selecione "opções". 
...
----------
 * **crianças** :: kids (noun)
 * São 10 horas. Você sabe onde as crianças estão? 
 ...
 * Next year is a leap year. 
----------
 * **receita** :: revenue (noun)
 * Os custos estão altos, a receita está baixa. O que você pode fazer? 
 * Costs are up, revenue is down. What can you do? 
----------
 * **fígado** :: liver (noun)
 * O álcool pode ser nocivo para o fígado. 
 ...
 * As baleias e golfinhos são mamíferos. 
 * Whales and dolphins are mammals. 
----------
 * **chá** :: tea (noun)
 * O chá tem que ferver um pouco mais. 
...
----------
 * **água** :: water (noun)
 * A Terra é coberta a maior parte por água. 
 * The Earth is covered mostly by water. 
----------
 * **açougueiro** :: butcher (noun)
 * O açougueiro me deu este bife de graça. 
...
----------
 * **medo** :: fear (noun)
 * O medo de mudar-se ou fazer mudanças é chamado de tropofobia. 
 * The fear of moving or making changes is called tropophobia. 
----------
 * **filme** :: movie (noun)
 * Adoro assistir filmes à noite. 
...
----------
 * **charada** :: riddle (noun)
 * Se a Esfinge te perguntar uma charada, é melhor você saber a resposta. 
 * If the Sphinx asks you a riddle, you better know the answer. 
----------
 * **gravar** :: to carve (verb)
 * Alguém gravou seu nome naquela árvore. 
 * Someone carved their name on that tree. 
----------
 * **lagartixa** :: gecko (noun)
 * Tem uma lagartixa na banheira! 
 * There is a gecko in the bathtub! 
----------
 * **abotoar** :: to button (verb)
 * Comi tanto que mal consigo abotoar minhas calças. 
 * I ate so much I can barely button my pants! 
----------
 * **frutas secas** :: dried fruit (noun)
 * As frutas secas são ricas em proteína. 
...
----------
 * **pôster** :: poster (noun)
 * Ele coleciona pôsteres de filmes de terror. 
 * He collects posters of old horror movies. 
----------
 * **escritor** :: writer (noun)
 * Eu quero ser escritor quando eu crescer. 
 ...
 * Sailboats use wind to move on the water. 
----------
 * **apresentar-se** :: to perform (verb)
 * Nós nos apresentamos no teatro comunitário. 
 * We performed in our community theater. 
----------
 * **cheque-mate** :: check-mate (expression)
 * Só faltam duas jogadas para o cheque-mate. 
...
----------
 * **afinar** :: to tune (verb)
 * Um perito sabe afinar um violino de ouvido. 
 * An expert can tune a violin by ear. 
----------
 * **crocante** :: crispy (adjective)
 * Gosto de cereal quando ainda está crocante. 
 ...
 * You can't pass on this stretch of road. 
----------
 * **ano letivo** :: school year (noun)
 * Todo verão, começa um ano letivo novamente. 
 * Every summer the school year begins anew. 
----------
 * **roteiro** :: script (noun)
 * Ele escreveu o roteiro para seu último filme. 
 * He wrote the script for his last movie. 
----------
 * **aleatoriamente** :: at random (adverb)
 * Escolhemos um lugar aleatoriamente. 
 * We chose a seat at random. 
----------
 * **gafanhoto** :: grasshopper (noun)
 * Ela tem muito medo de gafanhotos. 
 * She's really afraid of grasshoppers. 
----------
 * **tsunami** :: tsunami (noun)
 * Há um alerta de tsunami nesta área. 
 ...
 * I didn't mean to offend you. 
----------
 * **história** :: anecdote (noun)
 * Meu avô conhece centenas de histórias. 
 * My grandfather knows hundreds of anecdotes. 
----------
 * **usuário de internet** :: internet user (noun)
 * A maioria dos usuários de internet esperam conexões com velocidade rápida. 
 ...
 * My local car dealership doesn't have the model I'm looking for. 
----------
 * **anunciar** :: to announce (verb)
 * Eles vão anunciar o vencedor amanhã. 
 * They will announce the winner tomorrow. 
----------
 * **rastafari** :: dreadlocks (noun)
 * Você não fica bem de rastafari. 
...
----------
 * **ganso** :: goose (noun)
 * Dois gansos barulhentos moram perto do lago. 
 * Two noisy geese live near the pond. 
----------
 * **chocante** :: shocking (adjective)
 * As imagens do acidente eram chocantes. 
...
----------
 * **prata** :: silver (noun)
 * O problema com a prata é que ela mancha com muita facilidade. 
 * The problem with silver is that it tarnishes so easily. 
----------
 * **estar emburrado** :: to pout (expression)
 * O que você disse para sua irmã? Ela está emburrada novamente. 
 ...
 * The police found two corpses at the scene of the crime. 
----------
 * **fogos** :: fireworks (noun)
 * Os fogos iluminaram o céu. 
 * Fireworks lit the night sky. 
----------
 * **do seu lado** :: by your side (expression)
 * Eu quero passar o resto da minha vida do seu lado. 
 ...
 * From the main menu, select "options." 
----------
 * **limite de velocidade** :: speed limit (noun)
 * Sim, oficial, estou ciente do limite de velocidade. 
 * Yes, officer, I am aware of the speed limit. 
----------
 * **alvo** :: target (noun)
 * A flecha atingiu o centro do alvo. 
...
----------
 * **biscoitos** :: cookies (noun)
 * Minha mãe sempre me manda uma lata de biscoitos no Natal. 
...
----------
 * **banana** :: banana (noun)
 * Faço um bolo de bananas delicioso. 
 * I make this delicious banana cake. 
----------
 * **jamais** :: not in a million years (adverb)
 * Eu jamais assistiria aquele filme. 
 ...
 * The tea has to brew for a little bit longer. 
----------
 * **binóculos** :: binoculars (noun)
 * Por favor, passe-me os binóculos. 
 * Please pass me the binoculars. 
----------
 * **purificador de ar** :: air freshener (noun)
 * Um purificador de ar poderia eliminar o cheiro. 
 ...
 * The butcher gave me this steak for free. 
----------
 * **cegueira** :: blindness (noun)
 * Olhar fixamente o sol causa cegueira! 
 * Staring at the sun causes blindness! 
----------
 * **livrar-se de** :: to get rid of (verb)
 * Temos que nos livrar dos móveis velhos. 
 ...
 * I love to watch movies in the evening. 
----------
 * **chaleira** :: kettle (noun)
 * A chaleira já apitou? 
 * Has the kettle whistled yet? 
----------
 * **dor** :: pain (noun)
 * Ele quebrou o braço, mas não sentiu dor. 
 * He broke his arm, but didn't feel any pain. 
----------
 * **gravar** :: to carve (verb)
 * Alguém gravou seu nome naquela árvore. 
 * Someone carved their name on that tree. 
----------
 * **bota** :: boot (noun)
 * Suas botas estão cheias de lama. 
 * Your boots are full of mud. 
----------
 * **escudo** :: shield (noun)
 * O cavaleiro bloqueou o golpe com seu escudo. 
...
----------
 * **tijolo** :: brick (noun)
 * Conte os tijolos da parede se você está entediado. 
 * Count the bricks in the wall if you're bored. 
----------
 * **apertar a mão** :: to shake hands (expression)
 * É educado apertar a mão quando você conhece alguém. 
 * It's polite to shake hands when you meet someone. 
----------
 * **escritor** :: writer (noun)
 * Eu quero ser escritor quando eu crescer. 
 * I want to be a writer when I grow up. 
----------
 * **escovar** :: to brush (verb)
 * Ela precisa escovar seu cabelo. 
 * She needs to brush her hair. 
----------
 * **chiclete** :: chewing gum (noun)
 * Consigo andar e chupar chiclete ao mesmo tempo. 
 ...
 * Acidentalmente queimamos o bife. 
 * We accidentally burned the steak. 
----------
 * **ser caro** :: to be very expensive (expression)
 * Não comprei o último modelo porque é muito caro. 
 ...
 * Seus cavalos vivem no estábulo. 
 * Their horses live in the stable. 
----------
 * **teclado** :: keyboard (noun)
 * Não sei como trocar o layout do teclado. 
 ...
 * He wrote the script for his last movie. 
----------
 * **champanha** :: champagne (noun)
 * Traga a champanha, daremos os morangos. 
 * Bring champagne, we'll supply the strawberries. 
----------
 * **maçã** :: apple (noun)
 * Adoro comer torta de maçã de sobremesa. 
 * I love to eat apple pie for dessert. 
----------
 * **tsunami** :: tsunami (noun)
 * Há um alerta de tsunami nesta área. 
 * There is a tsunami alert in this area. 
----------
 * **atraente** :: attractive (adjective)
 * Admito, é uma oferta atraente. 
 * I admit, it is an attractive offer. 
----------
 * **avisar** :: to warn (verb)
 * Esta é a última vez que eu vou te avisar. 
...
----------
 * **chefe** :: boss (noun)
 * Nosso chefe nos trata com cortesia. 
 * Our boss treats us courteously. 
----------
 * **saúde** :: health (noun)
 * A saúde é melhor do que a riqueza. 
...
----------
 * **cavalo** :: horse (noun)
 * Eles criam cavalos naquela fazenda. 
 * They raise horses on that farm. 
----------
 * **riso** :: laughter (noun)
...
----------
 * **cidra** :: cider (noun)
 * Eles vendem cidra doce de maçã. 
 * They sell sweet apple cider. 
----------
 * **esforçar-se** :: to rack one's brains (verb)
 * Você terá de esforçar-se para lembrar. 
 ...
 * What did you say to your sister? She's pouting again. 
----------
 * **livro de recortes** :: scrapbook (noun)
 * Fiz um livro de recortes das nossas últimas férias. 
 * I made a scrapbook of our last vacation. 
----------
 * **guardanapo** :: napkin (noun)
 * Pode me trazer um outro guardanapo, por favor? 
...
----------
 * **charuto** :: cigar (noun)
 * Os charutos são umas das maiores exportações de Cuba. 
...
----------
 * **abraçar** :: to hug (verb)
 * A menina abraçou seu urso de pelúcia. 
 * The young girl hugged her teddy bear. 
----------
 * **perdoar** :: to forgive (verb)
 ...
 * My mother always sends me a tin of cookies for Christmas. 
----------
 * **cirurgião** :: surgeon (noun)
 * Ele talhou o assado com a precisão habilidosa de um cirurgião. 
 * He carved the roast with the skilled precision of a surgeon. 
----------
 * **estresse** :: stress (noun)
 * Estou sob muito estresse para dormir. 
 ...
 * I wouldn't watch that movie in a million years. 
----------
 * **recitar** :: to recite (verb)
 * Você consegue recitar o velho poema? 
 * Can you recite the old poem? 
----------
 * **paredes** :: the walls (noun)
 ...
 * Por favor, responda à pergunta honestamente. 
 * Please answer the question honestly. 
----------
 * **conversar** :: to talk (verb)
 * Tentar conversar com ele é como conversar com uma parede. 
 * Trying to talk to him is like talking to a wall. 
----------
 * **livrar-se de** :: to get rid of (verb)
 * Temos que nos livrar dos móveis velhos. 
 * We have to get rid of our old furniture. 
 ...
 * Estive no dentista mil vezes, então sei como funciona. 
 ...
 * He broke his arm, but didn't feel any pain. 
----------
 * **desenhar** :: to draw (verb)
 * Sei cantar, mas não sei desenhar. 
 * I can sing, but I can't draw. 
----------
 * **louco** :: crazy (adjective)
 * Somos todos um pouco loucos de uma maneira ou outra. 
 ...
 * The knight blocked the blow with his shield. 
----------
 * **estragar** :: to damage (verb)
 * Não estrague o pacote. 
 * Do not damage the package. 
----------
 * **não pregar o olho** :: to not sleep a wink (expression)
 * Não preguei o olho a noite toda porque tive insônia. 
 ...
 * It's polite to shake hands when you meet someone. 
----------
 * **diferença** :: difference (noun)
 * Que diferença um dia faz! 
 * What a difference a day makes! 
----------
 * **olho roxo** :: black eye (expression)
 * Tá, estou com o olho roxo, mas você tem que ver o outro cara! 
 ...
 * Vamos dividir o bolo em partes iguais. 
 * Let's divide the cake into equal parts. 
----------
 * **ficar** :: to stay (verb)
 * Por que você não tira seu casado e fica um pouco? 
...
----------
 * **dar** :: to give (verb)
 * O que você deu a ela no seu aniversário? 
 * What did you give her for her birthday? 
----------
 * **estar em promoção** :: to be on sale (expression)
 * Realmente não preciso disso, mas está em promoção. 
 ...
 * I don't know how to change the keyboard layout. 
----------
 * **duvidar** :: to doubt (verb)
 * Duvido a exatidão dessas medidas. 
 * I doubt the accuracy of these measurements. 
----------
 * **horrível** :: grotesque (adjective)
 * A cena da luta era horrível. 
 ...
 * I love to eat apple pie for dessert. 
----------
 * **tomar banho** :: to shower (verb)
 * Você pode tomar banho no banheiro de cima. 
 * You can shower in the bathroom upstairs. 
----------
 * **resmungar** :: to mumble (verb)
 * "Tudo bem, eu faço." John resmungou. 
 ...
 * Explique a solução para mim mais uma vez. 
 * Explain the solution to me one more time. 
----------
 * **encher** :: to fill (verb)
 * O simples fato de vê-lo a enche de alegria. 
 ...
 * Health is better than wealth. 
----------
 * **estranho** :: alien (adjective)
 * Nossos costumes devem parecer estranhos para você. 
 * Our customs must seem alien to you. 
----------
 * **estar ciente de** :: to be aware of (expression)
 * Você está ciente das consequências das suas ações? 
 ...
 * É sempre bom dar um bom exemplo para as crianças. 
 * It's always good to set a good example for kids. 
----------
 * **assustar** :: to startle (verb)
 * O som da explosão me assustou. 
 ...
 * You'll have to rack your brains to remember. 
----------
 * **escolher** :: to choose (verb)
 * Escolha uma carta, qualquer carta. 
 * Choose a card, any card. 
----------
 * **brigar** :: to quarrel (verb)
 * Eles passaram o tempo todo brigando. 
 ...
 * Mesmo depois de uma longa caminhada, o cachorrinho dela está energético! 
 ...
 * Don't get carried away by anger. 
----------
 * **enganado** :: mistaken (adjective)
 * Se você acha que eu vou fazer isso, você está completamente enganado. 
 * If you think I'm going to do that, you're completely mistaken. 
----------
 * **dono** :: master (noun)
 ...
 * To err is human, to forgive divine. 
----------
 * **exceção** :: exception (noun)
 * Há exceções para todas as regras. 
 * There are exceptions to every rule. 
----------
 * **pelo menos** :: at least (expression)
 * Pelo menos ele fez alguma coisa; os outros só olharam. 
...
----------
 * **fantasma** :: ghost (noun)
 * Dizem que fantasmas assombram a velha casa. 
 * They say that ghosts haunt the old house. 
----------
 * **palavrões** :: profanity (noun)
 * Não devemos usar palavrões aqui. 
 ...
 * Trying to talk to him is like talking to a wall. 
----------
 * **florescer** :: to flower (verb)
 * As árvores florescerão em algumas semanas. 
...
----------
 * **flor** :: flower (noun)
 * Coloque as flores no vaso na mesa. 
 ...
 * We're all a little crazy in one way or another. 
----------
 * **assustador** :: scary (adjective)
 * Você gosta de filmes assustadores? 
 ...
 * I didn’t sleep a wink all night because I had insomnia. 
----------
 * **retirar** :: to withdraw (verb)
 * Preciso retirar dinheiro do banco antes que feche. 
 * I need to withdraw some money from the bank before it closes. 
----------
 * **semente** :: seed (noun)
...
----------
 * **cavar** :: to dig (verb)
 * Cave até que você ache petróleo. 
...
----------
 * **fóssil** :: fossil (noun)
 * Os fósseis no museu são do período cretáceo. 
 ...
 * I don't really need this, but it's on sale! 
----------
 * **fotografar** :: to photograph (verb)
 * Ela fotografou um pássaro raro. 
 ...
 * As crianças patinam no lago quando ele está congelado. 
 ...
 * Are you aware of the consequences of your actions? 
----------
 * **skate** :: skateboard (noun)
 * Seu avô lhe deu um skate ano passado. 
 * His grandfather gave him a skateboard last year. 
----------
 ...
 * They spent the whole time quarrelling. 
----------
 * **formar-se** :: to graduate (verb)
 * Meu irmão vai se formar dentro de um mês. 
 ...
 * He is a spoiled child. 
----------
 * **cortador de grama** :: lawnmower (noun)
 * O cortador de grama precisa de gasolina. 
...
----------
 * **campina** :: meadow (noun)
 * Uma vasta campina se estendia abaixo do penhasco. 
 ...
 * At least he did something; everyone else just watched. 
----------
 * **história** :: history (noun)
 * Eles estudaram história na universidade. 
...
----------
 * **relógio** :: clock (noun)
 * Trinta anos atrás, caiu um raio naquela torre do relógio. 
 ...
 * Mom, I want to get on the ferris wheel! 
----------
 * **sugerir** :: to imply (verb)
 * O que você acha que o discurso sugeriu? 
...
----------
 * **imposto** :: tax (noun)
 * Não se esqueça de pagar seus impostos! 
 ...
 * Os atores improvisaram a cena inteira 
 * The actors improvised the entire scene. 
----------
 * **abacaxi** :: pineapple (noun)
 * Elas não gostam de abacaxi. É azedo! 
 * They don't like pineapple. It's sour! 
----------
 * **opor-se** :: to object (verb)
 * Seu pai não se opôs desta vez? 
 * Didn't your father object this time? 
----------
 * **gastar** :: to spend (expression)
 * Ela gastou muito dinheiro na feira. 
 * She spent a lot of money at the open market. 
----------
 * **maça** :: apple (noun)
 * Maças são muito saudáveis. 
...
----------
 * **uva** :: grape (noun)
 * Gosto muito das uvas italianas. São bem doces. 
 * I like Italian grapes. They are very sweet. 
----------
 * **manjericão** :: basil (noun)
 * O manjericão é o ingrediente principal do pesto. 
 * Basil is the main ingredient in pesto. 
 ...
 * Can you lend me some money? 
----------
 * **viajar** :: to travel (expression)
 * O casal viajou de lua de mel. 
 * The couple traveled on their honeymoon. 
----------
 * **agitado** :: frantic (adjective)
 * Meu gato ficou agitado assim que o carro começou a andar. 
 * My cat became frantic as soon as the car began to move. 
