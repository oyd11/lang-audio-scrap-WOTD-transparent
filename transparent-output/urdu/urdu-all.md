...
----------
 * **دھیان** :: notice (noun)
 * میں قریب آتے بھیڑیوں کے غول پے دھیان دینے میں ناکام رہا. 
 ...
 * Are you happy? 
----------
 * **موسیقی کا مدرسہ** :: music academy (noun)
 * اس نے ویانا میں موسیقی کے مدرسہ میں تعلیم حاصل کی. 
 * He studied at the music academy in Vienna. 
----------
 * **گرین ہاؤس** :: greenhouse (noun)
 * سائنسدان گرین ہاؤس اثر کے بارے میں فکرمند ہیں. 
 * Scientists worry about the Greenhouse Effect. 
----------
 * **کوشش** :: attempt (noun)
 * وہ عالمی ریکارڈ کو توڑنے کی کوشش میں ناکام رہا. 
 * He failed in his attempt to beat the world record. 
----------
 * **بحث** :: argument (noun)
 * ہم نے پیسے کے بارے میں ایک بحث کی تھی. 
 * We had an argument about money. 
----------
 * **لائحہ عمل** :: agenda (noun)
 * لائحہ عمل پر چھٹی چیز کافی دلچسپ لگتی ہے. 
 * The sixth item on the agenda looks very interesting. 
----------
 * **مشورہ** :: to advise (verb)
 * ڈاکٹر نے اسے مشورہ دیا کہ وہ کیسے اپنے بچے کی دیکھ بھال کرے. 
 * The doctor advised her how to take care of her baby. 
----------
 * **شروع کرنا** :: to start (verb)
 * چلو اس جشن کو شروع کریں. 
 * Let's get this party started. 
----------
 * **تعارف کرنا** :: to introduce (verb)
 * میں ہمارے اگلے سپیکر، مسٹر جارڈن چیس کا تعارف کرانا چاہوں گا. 
 * I'd like to introduce our next speaker, Mr. Jordan Chase. 
----------
 * **موافق ہونا** :: to match (verb)
 * اس کے واقعات کی روداد سَچّائی سے موافق نہیں ہے. 
 * Her version of the events does not match up with the truth. 
----------
 * **کیمپنگ کےلئے جانا** :: to go camping (expression)
 * میں ایک بچے کے طور پر کیمپنگ کرنے جاتا تھا. 
 * I used to go camping as a child. 
----------
 * **بارش رکنا** :: to stop raining (expression)
 * ہم چہل قدمی کے لیے جائیں گے جب بارش رک جائے گی. 
 * When it stops raining we will go for a walk. 
----------
 * **بیمار ہونا** :: to get sick (expression)
 * میں بیمار نہيں ہو سکتی، میری چھٹی کل شروع ہے! 
 * I can't get sick now; my vacation starts tomorrow! 
----------
 * **یقیناً** :: certainly (adverb)
 * یقیناً میں تمام لوگ جو کہتے ہیں ان کے ساتھ اتفاق کرتا ہوں. 
...
----------
 * **دھوکا دینا** :: to cheat (verb)
 * کیا تمہیں لگتا ہے کہ تم مجھے دھوکہ دے سکتے ہو؟ پھر سوچ لو! 
 * Do you think you can cheat me? Think again! 
----------
 * **لہر** :: wave (noun)
 * مجھے کالے سمندر کی لہریں پسند ہیں. 
 * I like the waves of the Black Sea. 
----------
 * **کسی پر اعتبار کرنا** :: to trust somebody (expression)
 * اس نے ہمیشہ ہمیں دھوکہ دیا، مجھے اس پر اعتبار نہیں ہے. 
 * He always deceives us; I don't trust him. 
----------
 * **جیب کترا** :: pick-pocket (noun)
 * پولیس نے کل رات ایک جیب کترے کو گرفتار کیا. 
 * The police arrested a pick-pocket last night. 
----------
 * **بورنگ ہونا** :: to be a bore (expression)
 * وہ کتنا بورنگ ٹیچر ہے. 
 * He is such a bore of a teacher. 
----------
 * **بیسواد** :: tasteless (adjective)
 * جب کسی کو زکام ہو تو کھانا بیسواد لگتا ہے. 
 * Food seems tasteless when one has a cold. 
----------
 * **موڈ** :: mood (noun)
 * میں مذاق کے موڈ میں نہيں ہوں. 
 * I'm not in the mood for jokes. 
----------
 * **پکڑنا** :: to hold (verb)
 * ایک لمحہ یہ ماہی گیری و الا ڈَنڈا پکڑو. 
 * Hold this fishing pole a moment. 
----------
 * **جلد ہی ملیں گے!** :: See you soon! (expression)
 * اب مجھے جانا ہے، تو جلد ہی ملیں گے! 
 * I've got to go now - see you soon! 
----------
 * **پرسکون نیند** :: to sleep like a log (expression)
 * اس رات میں ایک پرسکون نیند سو یا اور میں نے کچھ نہیں سنا. 
 * That night I slept like a log and I didn't hear anything. 
----------
 * **کار آمد** :: useful (adjective)
 * معاشیات پر یہ مضمون میری تحقیق کے لئے کافی کار آمد تھا. 
 * The article on economics was very useful for my research. 
----------
 * **آسیب** :: goblin (noun)
 * میرے بھتیجے کو آسیب اور پریوں کی کہانیاں پسند ہیں. 
 * My nephew likes stories with goblins and fairies. 
----------
 * **صحت مند** :: healthy (adjective)
 * روزانہ ورزش کرنا ایک صحت مند سرگرمی ہے. 
 * Doing daily exercise is a healthy activity. 
----------
 * **مستعدی** :: agility (noun)
 * ایک گارڈ کے طور پر کھیلنے کے لیے میرے اندر کافی مستعدی نہیں ہے. 
 * I don't have enough agility to play as a guard. 
----------
 * **آستین** :: sleeve (noun)
 * ٹھنڈ ہے، تمہیں کچھ ایسا پہننا چاہئے جس کی لمبی آستینیں ہوں. 
 * It's cold; you'd better wear something with long sleeves. 
----------
 * **وصول کرنا** :: to receive (verb)
 * میں نقد انعام وصول کرنے کو ترجیح دیتا ہوں. 
 * I'd rather receive the prize in cash. 
----------
 * **نوٹری** :: notary (noun)
 * معاہدہ ایک نوٹری کے سامنے دستخط ہونا ضروری ہے. 
 * The contract has to be signed in front of a notary. 
----------
 * **چپپل** :: slipper (noun)
 * اس نے اپنی چپپل اتار کر دوبارہ جوتے پہن لیے. 
 * She took off her slippers and put on her shoes again. 
----------
 * **ہیلی کاپٹر** :: helicopter (noun)
 * سیلاب زدگان کو ہیلی کاپٹر سے بچا لیا گیا. 
 * The flood victims were rescued in a helicopter. 
----------
 * **شطرنج** :: chess (noun)
 * شطرنج کی اچھی بازی کے بارے میں کیا خیال ہے؟ 
 * How about a nice game of chess? 
----------
 * **چھت** :: roof (noun)
 * مجھے چھت پر ایک باغ کی تعمیر کا شوق ہے. 
 * I would love to build a garden on the roof. 
----------
 * **اے ٹی ایم** :: ATM (noun)
 * مجھے نقد ادا کرنے کی ضرورت ہے. یہاں کوئی اے ٹی ایم ہے؟ 
 * I need to pay in cash. Is there an ATM here? 
----------
 * **فلیٹ** :: flat (noun)
 * میرا فلیٹ پہلی منزل پر ہے. 
 * My flat is on the first floor. 
----------
 * **ہزار** :: thousand (determiner)
 * ایسا کرنے کی ایک ہزار وجوہات ہیں. 
 * There are a thousand reasons to do it. 
----------
 * **پسینہ** :: sweat (noun)
 * میں دوڑ کے بعد پسینے میں بھیگی ہوں. 
...
----------
 * **کڑوا** :: bitter (adjective)
 * مجھے کڑوی کافی پسند نہیں ، میں اسے تھوڑی چینی کے ساتھ پسند کرتا ہوں. 
 * I don't like bitter coffee; I prefer it with a bit of sugar. 
----------
 * **چھوڑ دینا** :: to dispense with (verb)
 * چلو غیر ضروری تفصیلات چھوڑ دو. 
 * Let's dispense with the unnecessary details. 
----------
 * **مارکر** :: marker (noun)
 * میں اورینج مارکر چاہتا ہوں، براہ مہربانی. 
 * I want the orange marker, please. 
----------
 * **بالٹی** :: bucket (noun)
 * والرس کے پاس ایک بالٹی ہے. 
 * The walrus has a bucket. 
----------
 * **کتا** :: dog (noun)
 * میں تم کو پکڑ لوں گا، میری پیاری، اور تمھارے کتے کو بھی! 
 * I'll get you, my pretty, and your little dog, too! 
----------
 * **ولی** :: saint (noun)
 * میں ایک ولی نہیں ہوں. 
 * I'm not a saint. 
----------
 * **نامَعلُوم** :: unknown (adjective)
 * اس کا ٹھکانہ نامعلوم ہے، لیکن مجھے لگتا ہے کہ وہ ملک سے فرار ہوگیا ہے. 
...
----------
 * **ٹکڑا** :: piece (noun)
 * میں کاغذ کا ایک ٹکڑا چاہتا ہوں. 
 * I want a piece of paper. 
----------
 * **پہلے پہل** :: at first (expression)
 * پہلے پہل مجھے نہیں پتا تھا کہ کیا کہنا ہے. 
 * At first I didn't know what to say. 
----------
 * **کمی** :: shortage (noun)
 * یورپ میں رہائش کی کمی ہے. 
 * In Europe there is a housing shortage. 
----------
 * **آخر میں** :: in the end (expression)
 * آخر میں نے اعتراف کیا کہ وہ صحیح تھا. 
 * In the end I had to admit that he was right. 
----------
 * **شرمیلا** :: shy (adjective)
 * دوست بنانا مشکل ہے جب آپ تکلیف دہ حد تک شرمیلی ہوں. 
 * Making friends is hard when you are painfully shy. 
----------
 * **پھُول** :: flower (noun)
 * ایک پراسرار پرستار نے مجھے پھول بھیجے! 
 * A mysterious admirer sent me flowers! 
----------
 * **ابھی تک** :: yet (adverb)
 * وہ ابھی تک نہیں گئ ہے. 
 * She hasn't gone yet. 
----------
 * **کپڑے** :: clothing (noun)
 * ان گندے کپڑوں کو اتارو! 
 * Take those dirty clothes off! 
----------
 * **شعلہ** :: flame (noun)
 * آگ کے شعلہ نے سیکنڈ میں خفیہ پیغام کو تباہ کر ڈالا. 
 * The flame destroyed the secret message in seconds. 
----------
 * **خلاف** :: against (adverb)
 * کبھی کبھی ایسا لگتا ہے جیسے ساری دنیا میرے خلاف ہے! 
 * Sometimes it feels like the whole world is against me! 
----------
 * **روشنی** :: light (noun)
 * ہم چیزوں کو دن کی سرد روشنی میں واضح طور پر دیکھیں گے. 
 * We'll see things clearly in the cold light of day. 
----------
 * **پیشکش** :: offer (noun)
 * میں اسے ایک ایسی پیشکش کرنےجا رہا ہوں جس سے وہ رد نہیں کر سکتا. 
 * I'm going to make him an offer he can't refuse. 
----------
 * **اختتام** :: end (noun)
 * یہ الفاظ تین سال کے تنازع کا اختتام لائے. 
 * These words brought three years of conflict to an end. 
----------
 * **شادی کرنا** :: to get married (verb)
 * تم شادی کب کر رہے ہو؟ 
 * When are you getting married? 
----------
 * **محبت** :: love (noun)
 * میں تمہیں ہمیشہ کے لئے محبت کروں گا. 
 * I will love you forever. 
----------
 * **کدو** :: pumpkin (noun)
 * ہم نے آگے کی سیڑھیوں پر رکھنے کےلیے کدو تراشے. 
 * We carved pumpkins to put on the front steps. 
----------
 * **چلے جانا** :: to leave (verb)
 * جہاز دس منٹ پہلے چلا گیا. ہم کیا کریں؟ 
 * The plane left ten minutes ago. What do we do? 
----------
 * **شیر** :: lion (noun)
 * میری بہن چڑیاگھر میں شیروں سے لطف اندوز ہوتی ہے. 
 * My sister enjoys the lions at the zoo. 
----------
 * **اسکول** :: school (noun)
 * وہ اسکول نہیں جانا چاہتا. 
 * He does not want to go to school. 
----------
 * **سیکھنا** :: to learn (verb)
 * میں زیادہ جرمن سیکھنا چاہتا ہوں. 
 * I want to learn more German. 
----------
 * **لفٹ** :: elevator (noun)
 * لفٹ لے لو نویں منزل کےلیے. 
 * Take the elevator to the ninth floor. 
----------
 * **ایک آلہ بجانا** :: to play an instrument (verb)
 * وہ ایک استاد کی طرح پیانو بجاتا ہے. 
 * He plays the piano like a master. 
----------
 * **ڈاایس** :: dice (noun)
 * یہ آپ کی ڈاایس رول کرنے کی باری ہے. 
...
----------
 * **ظاہِر کَر دینا** :: to uncover (verb)
 * ان کی مہم نے قدیم آثار ظاہر کر دیے. 
 * Their expedition uncovered ancient ruins. 
----------
 * **غَیر صحَت مند** :: unhealthy (adjective)
 * تمباکو نوشی ایک غَیر صحَت مند عادت ہے. 
 * Smoking is an unhealthy habit. 
----------
 * **ٹھنڈا کرنا** :: to cool (verb)
 * پنکھا کمرے کو ٹھنڈا کرے گا. 
 * The fan will cool the room. 
----------
 * **نیلی** :: navy (adjective)
 * اندھیرے میں میں نے غلطی سے ایک نیلی اور ایک کالی جراب پہن لی. 
 * In the dark I accidentally put on one navy sock and one black. 
----------
 * **لٹکنا** :: to hang (verb)
 * وہاں چھت سے جالے لٹک رہے ہیں. 
...
----------
 * **سینہ** :: chest (noun)
 * میرے سینے میں تکلیف ہے. 
 * My chest hurts. 
----------
 * **جھوٹا** :: liar (adjective)
 * تم ایسے جھوٹے ہو! 
 * You're such a liar! 
----------
 * **کھونا** :: to lose (verb)
 * میرے پاس کھونے کے لئے کچھ نہیں ہے. 
